...
export function DashboardTabs({
    ...
    return (
        <>
                ...
                <TabsContent value="invoices" forceMount={shouldForceMount('invoices')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    <ResourceLimitBanner
                ...
                <TabsContent value="inventory" forceMount={shouldForceMount('inventory')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    <ResourceLimitBanner
                ...
                <TabsContent value="customers" forceMount={shouldForceMount('customers')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                ...
                <TabsContent value="vendors" forceMount={shouldForceMount('vendors')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                ...
                <TabsContent value="payments" forceMount={shouldForceMount('payments')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                ...
                <TabsContent value="purchases" forceMount={shouldForceMount('purchases')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                ...
                <TabsContent value="sales" forceMount={shouldForceMount('sales')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                ...
                <TabsContent value="gst" forceMount={shouldForceMount('gst')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                ...
                <TabsContent value="pos" forceMount={shouldForceMount('pos')} className="data-[state=inactive]:hidden outline-none mt-0 pt-2 lg:pt-3">
                    {wrapTab(
                        <TabGuard
                            tabKey="pos"
                            role={role}
                ...
                <TabsContent value="orders" forceMount={shouldForceMount('orders')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                        <TabGuard
                            tabKey="orders"
                            role={role}
                ...
                <TabsContent value="inquiries" forceMount={shouldForceMount('inquiries')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                        <TabGuard
                            tabKey="inquiries"
                            role={role}
                ...
                <TabsContent value="restaurant" forceMount={shouldForceMount('restaurant')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
                        <TabGuard
                            tabKey="restaurant"
                            role={role}
                ...
                <TabsContent value="audit" forceMount={shouldForceMount('audit')} className="data-[state=inactive]:hidden space-y-6 outline-none">
                    {wrapTab(
