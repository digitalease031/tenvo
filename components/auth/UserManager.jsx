                                ...
                                <button
                                    onClick={(e) => {
                                        ...
                                        if (!canUseAdvancedDashboard) {
                                            toast('Pro dashboard requires Professional plan or above', { icon: '🔒' });
                                            return;
                                        }
                                        setAppMode('advanced');
                                    }}
                                    title={!canUseAdvancedDashboard ? 'Requires Professional plan' : undefined}
                                    className={cn(
                                        "px-2.5 py-0.5 text-[10px] font-bold rounded-md transition-all",
                                        !isEasyMode
                                            ? "bg-brand-primary text-white shadow-sm font-semibold"
                                            : "text-gray-500 hover:text-gray-700",
                                        !canUseAdvancedDashboard && "opacity-50 cursor-not-allowed"
                                    )}
                                >
                                    Pro
                                </button>
