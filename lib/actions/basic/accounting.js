...
/**
 * Reverse a posted Journal Entry (Double-Entry Reversal)
 */
export async function reverseJournalAction(data) {
    try {
        const businessId = pickBusinessId(data);
        if (!businessId) {
            return { success: false, error: 'Business ID is required', code: 'MISSING_BUSINESS_ID' };
        ...
        const result = await AccountingService.reverseJournalEntry({
            ...data,
            businessId,
            userId: session.user.id
        });
        ...
        console.error('reverseJournalAction error:', error);
        return { success: false, error: error.message, code: error.code || 'UNKNOWN_ERROR' };
    }
}
 ...
 */
export async function postDraftJournalAction(data) {
    try {
        const businessId = pickBusinessId(data);
        if (!businessId) {
            return { success: false, error: 'Business ID is required', code: 'MISSING_BUSINESS_ID' };
        ...
        const result = await AccountingService.postDraftJournalEntry({
            ...data,
            businessId
        });
        ...
        console.error('postDraftJournalAction error:', error);
        return { success: false, error: error.message, code: error.code || 'UNKNOWN_ERROR' };
    }
}
