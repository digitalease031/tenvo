...
export async function createInvoiceAction(params) {
    try {
        ...
        void purgeTenantCacheKey(invoiceData.business_id, 'dashboard');
...
export async function deleteInvoiceAction(businessId, invoiceId) {
    try {
        ...
        void purgeTenantCacheKey(businessId, 'invoice-list');
        void purgeTenantCacheKey(businessId, 'dashboard');
...
export async function updateInvoiceAction(params) {
    try {
        ...
        void purgeTenantCacheKey(invoice.business_id, 'invoice-list');
        void purgeTenantCacheKey(invoice.business_id, 'dashboard');
