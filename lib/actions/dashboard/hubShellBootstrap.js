...
export async function getHubShellBootstrapAction(businessId, filter = {}) {
    ...
    try {
        ...
        const purchasesRes = settledValue(purchasesSettled, { success: false });
        const purchaseOrders = purchasesRes?.success ? purchasesRes.purchases || [] : [];
