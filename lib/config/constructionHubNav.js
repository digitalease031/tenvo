...
export const CONSTRUCTION_HUB_TABS = [
  ...
  },
  {
    ...
    label_ur: 'لیٹر ہیڈ اور دستاویزات',
    icon: 'FileSpreadsheet',
    description: 'Design, customize, and print official company letterheads with logo & watermark',
    featureGate: null,
  },
  {
    id: 'settings',
...
// ── Hub Nav Sections (for Vertical Sidebar Navigation) ───────────────────────

export const CONSTRUCTION_HUB_SECTIONS = [
  {
    id: 'overview-intelligence',
    title: 'Overview & Intelligence',
    title_ur: 'جائزہ اور انٹیلی جنس',
    tabIds: ['overview', 'letterhead', 'material-rates', 'tax-compliance'],
  },
  {
    id: 'project-management',
    title: 'Project Management',
    title_ur: 'پروجیکٹ مینجمنٹ',
    tabIds: ['projects', 'boq', 'ipc'],
  },
  {
    id: 'site-field-ops',
    title: 'Site & Field Operations',
    title_ur: 'سائٹ اور فیلڈ آپریشنز',
    tabIds: ['site-materials', 'machinery', 'subcontractors', 'site-ops'],
  },
  {
    id: 'finance-compliance',
    title: 'Finance & Compliance',
    title_ur: 'فنانس اور تعمیل',
    tabIds: ['finance', 'procurement', 'reports', 'settings'],
  },
];
