...
/** Construction & Infrastructure Contractor package feature overrides. */
const CONSTRUCTION_DESIRED = {
  restaurant_pos: false,
  restaurant_kds: false,
  membership_management: false,
  loyalty_programs: false,
...
/**
 * Lean strip for construction-contractor tenants (any plan tier).
 * Ensures F&B / loyalty / membership / storefront-cart chrome stays off
 * without requiring the construction-management package SKU.
 * @returns {Record<string, boolean>}
 */
export function getConstructionLeanFeatureStrip() {
  /** @type {Record<string, boolean>} */
  const strip = {};
  for (const [key, value] of Object.entries(CONSTRUCTION_DESIRED)) {
    if (value === false) strip[key] = false;
  }
  return strip;
}

export const CONSTRUCTION_MANAGEMENT_FEATURE_OVERRIDES = Object.freeze(
  buildDomainPackageFeatureOverrides('enterprise', CONSTRUCTION_DESIRED)
);

export const CONSTRUCTION_MANAGEMENT_HIGHLIGHTS = pickEnabledPackageFeatures(CONSTRUCTION_DESIRED, [
  'manufacturing',
  'multi_warehouse',
  'expense_tracking',
  'approval_workflows',
...
/** EV & Electric Bike Commerce Suite package feature overrides. */
const EV_BIKES_DESIRED = {
  restaurant_pos: false,
  restaurant_kds: false,
  membership_management: false,
  payroll: false,
...
export const EV_BIKES_COMMERCE_FEATURE_OVERRIDES = Object.freeze(
  withBusinessDefaults(EV_BIKES_DESIRED)
);

export const EV_BIKES_COMMERCE_HIGHLIGHTS = pickEnabledPackageFeatures(EV_BIKES_DESIRED, [
  'serial_tracking',
  'batch_tracking',
  'pos',
  'storefront_orders',
...
/** Lubricant & Engine Oil Distribution Management System (LDMS) feature overrides. */
const LUBRICANT_DISTRIBUTION_DESIRED = {
  restaurant_pos: false,
  restaurant_kds: false,
  membership_management: false,
  payroll: false,
...
export const LUBRICANT_DISTRIBUTION_FEATURE_OVERRIDES = Object.freeze(
  withBusinessDefaults(LUBRICANT_DISTRIBUTION_DESIRED)
);

export const LUBRICANT_DISTRIBUTION_HIGHLIGHTS = pickEnabledPackageFeatures(LUBRICANT_DISTRIBUTION_DESIRED, [
  'batch_tracking',
  'multi_warehouse',
  'price_lists',
  'supplier_quotes',
...
/** Hardware & Architectural Fittings Commerce Suite feature overrides. */
const HARDWARE_COMMERCE_DESIRED = {
  restaurant_pos: false,
  restaurant_kds: false,
  membership_management: false,
  payroll: false,
...
export const HARDWARE_COMMERCE_FEATURE_OVERRIDES = Object.freeze(
  withBusinessDefaults(HARDWARE_COMMERCE_DESIRED)
);

export const HARDWARE_COMMERCE_HIGHLIGHTS = pickEnabledPackageFeatures(HARDWARE_COMMERCE_DESIRED, [
  'batch_tracking',
  'serial_tracking',
  'multi_warehouse',
  'pos',
