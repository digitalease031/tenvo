...
export const PLAN_TIERS = {
    ...
    free: {
        ...
        features: {
            ...
            /** Storefront / online orders tab - gated to Professional+ */
            storefront_orders: false,
            /** Sales workspace tab - gated to Professional+ */
            sales_hub: false,
            /** Finance Hub full GL/trial balance - gated to Professional+ */
            finance_hub: false,
            /** Standalone quotations tab - gated to Professional+ */
            quotations: false,
            /** Standalone refunds tab - gated to Professional+ */
            standalone_refunds: false,
            /** Advanced (Pro) dashboard mode — full analytics, multi-tab ERP view */
    ...
    business: {
        ...
        features: {
            ...
            // INTELLIGENCE - AI & GenAI (Enterprise Tier Only for API-based AI)
            ai_analytics: false,
            ai_forecasting: false,
            ai_restock: false,
            ai_price_optimization: false,
            ai_promotion_recommendations: false,
            ai_churn_prediction: false,
            advanced_reports: true,
            custom_reports: true,
            
            // GENAI - Enterprise Tier Only
            genai_product_descriptions: false,
            genai_content_writer: false,
            genai_email_campaigns: false,
            genai_chatbot: false,
            genai_business_analyst: false,
    ...
    enterprise: {
        ...
        features: {
            ...
            // CONSTRUCTION DOMAIN — Enterprise-gated features
            // Available on enterprise plan + construction-management package via packaging overrides
...
export const FEATURE_LABELS = {
    ...
    advanced_dashboard: 'Pro Dashboard (Advanced Analytics)',
...
export function planHasFeature(planTier, feature) {
    ...
    if (feature === 'purchases' || feature === 'purchase_orders') {
        return plan.features.purchases === true || plan.features.purchase_orders === true;
    }
