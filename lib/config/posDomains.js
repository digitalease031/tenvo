...
export function getPosDomainFlags(category) {
    ...
    return {
        ...
        barcodeFirst: variant === 'superstore' || [
            ...
            'textile-wholesale', 'auto-parts', 'lubricant-distribution',
        ].includes(key),
        supportsWeight: variant === 'superstore' || [
            'butcher-meat-shop', 'textile-wholesale', 'textile-mill', 'agriculture', 'milk-shop',
        ].includes(key),
        supportsBulkQty: variant === 'superstore' || key === 'wholesale-distribution' || key === 'lubricant-distribution',
        ...
        wholesaleMode: key === 'wholesale-distribution' || key === 'textile-wholesale' || key === 'lubricant-distribution',
