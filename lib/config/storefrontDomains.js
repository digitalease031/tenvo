...
export const STOREFRONT_DOMAIN_CONFIG = {
  ...
  'ev-bikes': {
    label: 'EV Bikes & Scooters',
    heroTagline: 'Ride Electric. Ride Freedom.',
    heroSubtitle: 'High-performance Vlektra EV motorbikes, Metro EV smart scooters, and Ramza Aima e-bikes with zero emissions.',
    ctaLabel: 'Discover EV Models',
    accentColor: '#991b1b',
    accentDark: '#450a0a',
    accentLight: '#7f1d1d',
    heroImage: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=1600&q=80&auto=format&fit=crop',
    categoryImages: {
      default: 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&q=80&auto=format&fit=crop',
    },
    trustBadges: [
      { icon: 'zap', title: '0 Emissions', subtitle: '100% eco-friendly electric ride' },
      { icon: 'shield', title: 'Battery Warranty', subtitle: 'Up to 3-year lithium warranty' },
      { icon: 'clock', title: 'Fast Charging', subtitle: 'Full charge in 3-4 hours' },
      { icon: 'star', title: 'Free Test Ride', subtitle: 'Schedule at your nearest showroom' },
    ],
    featuredSectionTitle: 'Featured EV Models',
    newArrivalsSectionTitle: 'New EV Arrivals',
    bannerText: '⚡ Zero Emissions · Instant Torque · Free Showroom Test Ride',
  },
  ...
  'construction-contractor': {
    ...
    heroTagline: 'CONSIGLI AT A GLANCE - LIFE SCIENCES & CIVIL CONSTRUCTION',
    heroSubtitle: 'Innovation starts with a dream and a plan. Quality construction management, EPC contracting, and BOQ materials.',
    ctaLabel: 'Discover Work',
    accentColor: '#a71930',
    accentDark: '#800000',
    accentLight: '#fef2f2',
    heroImage: '/tenvo-img/construction/construction-1.jpg',
    categoryImages: {
      default: '/tenvo-img/construction/construction-service.jpg',
      vdc: '/tenvo-img/construction/service2.jpg',
      housing: '/tenvo-img/construction/affordable.jpg',
    },
    trustBadges: [
      { icon: 'shield', title: 'PEC & PPRA Registered', subtitle: 'Category C-A / C-1 License' },
      { icon: 'truck', title: 'Site Delivery & RMC', subtitle: 'Batching plant dispatch' },
      { icon: 'star', title: 'Grade 60 ASTM Rebar', subtitle: 'ISO 9001 certified' },
      { icon: 'user', title: 'FIDIC & VDC Compliant', subtitle: 'Standard IPC & BOQ docs' },
    ],
    featuredSectionTitle: 'Featured Projects',
    newArrivalsSectionTitle: 'BOQ Materials & Services',
    bannerText: '🏗️ BOQ-ready construction materials, RMC, and turnkey EPC management',
  },
...
export const STOREFRONT_CATEGORY_TO_VERTICAL = {
  ...
  'civil-engineering': 'construction-contractor',
...
function inferVerticalFromCategorySlug(c) {
  ...
  if (/construction|contractor|civil|infrastructure|epc|builder|bridg|highway|dam|irrigation/.test(c)) return 'construction-contractor';
  return null;
}
