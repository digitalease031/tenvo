        ...
        if (existingIndex >= 0) {
          ...
          newItems = prev.items.map((item, i) =>
            i === existingIndex
              ? {
                  ...
                  maxQuantity,
                  domain_data: product.domain_data || item.domain_data || null,
                  brand: product.brand || item.brand || null,
                  category: product.category_name || product.category || item.category || null,
                }
              : item
          );
        } else {
          newItems = [
            ...prev.items,
            {
              ...
              domain_data: product.domain_data || null,
