...
const VERTICAL_PLAYBOOKS = {
  ...
  'textile-wholesale': {
    stockFocus: 'Track by Article/Design/Color — thaan-level stock, roll counts, and total Stock value. Watch slow-moving designs before seasonal changeover (Eid, Winter, Summer).',
    salesFocus: 'Bulk invoice cadence with thaan/meter/suit qty. Seasonal peaks (Eid, Back-to-School) demand early procurement 6-8 weeks ahead. Create invoice for quick dispatch.',
    accountsFocus: 'Long credit cycles (30-60 days) — prioritize overdue wholesale accounts. Watch party-wise Outstanding balance and set Credit limits per customer. Record payment to clear ledger balance.',
    actionTab: 'invoices',
    quickView: {
      title: 'Wholesale Control Panel',
      metrics: [
        { key: 'partyOutstanding', label: 'Party Outstanding', format: 'currency', alert: 'high' },
        { key: 'thaanStock', label: 'Thaan Stock', format: 'number', alert: 'low' },
        { key: 'todayInvoices', label: 'Today Invoices', format: 'number' },
        { key: 'pendingPayments', label: 'Due Collections', format: 'currency', alert: 'high' },
      ],
      actions: [
        { id: 'quick-invoice', label: 'Quick Invoice', primary: true },
        { id: 'record-payment', label: 'Receive Payment' },
        { id: 'party-ledger', label: 'Party Ledger' },
        { id: 'stock-check', label: 'Article Stock' },
      ],
    },
  },
  'auto-parts': {
  ...
  'construction-contractor': {
    stockFocus: 'BOQ material stock — ASTM Grade 60 Rebar, OPC Cement, RMC Concrete, and crushed aggregate. Track site requisitions and batch consumption.',
    salesFocus: 'Interim Payment Certificates (IPC) running bills and PEC/PPRA compliant contract milestones. Monitor unbilled work and pending IPC approvals.',
    accountsFocus: 'Subcontractor retainage ledger, mobilization advance recovery, and FBR Sec 153 WHT tax deductions. Cash flow vs certified work.',
    actionTab: 'projects',
  },
  contractor: {
    stockFocus: 'BOQ material stock — ASTM Grade 60 Rebar, OPC Cement, RMC Concrete, and crushed aggregate.',
    salesFocus: 'Interim Payment Certificates (IPC) running bills and PEC/PPRA compliant contract milestones.',
    accountsFocus: 'Subcontractor retainage ledger, mobilization advance recovery, and FBR Sec 153 WHT tax deductions.',
    actionTab: 'projects',
  },
  construction: {
    stockFocus: 'BOQ material stock — ASTM Grade 60 Rebar, OPC Cement, RMC Concrete, and crushed aggregate.',
