...
const VERTICAL_PLAYBOOKS = {
  ...
  'textile-wholesale': {
    stockFocus: 'Track by Article/Design/Color — thaan-level stock and roll counts. Watch slow-moving designs before seasonal changeover (Eid, Winter, Summer).',
    salesFocus: 'Bulk invoice cadence with thaan/meter/suit qty. Seasonal peaks (Eid, Back-to-School) demand early procurement 6-8 weeks ahead.',
    accountsFocus: 'Long credit cycles (30-60 days) — prioritize overdue wholesale accounts. Watch party-wise outstanding and set credit limits per customer.',
    actionTab: 'invoices',
    quickView: {
