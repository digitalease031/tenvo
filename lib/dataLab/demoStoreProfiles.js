...
const BY_DOMAIN_KEY = {
  ...
  'ev-bikes': {
    description:
      'Tenvo EV is Pakistan’s leading electric motorcycle & scooter showroom. Discover high-performance Vlektra EV motorbikes, Metro EV smart scooters, and Ramza Aima e-bikes with lithium battery serial tracking, fast chargers, and free test rides.',
    city: 'Lahore',
    address: 'MM Alam Road, Gulberg III',
    businessHours: 'Mon - Sat, 10:00 AM - 9:00 PM',
    freeShippingThreshold: 50000,
    returnPolicyDays: 7,
    announcement: '⚡ Electric Mobility Suite · Vlektra, Metro EV & Ramza Aima · Book a Free Test Ride Today',
    accentColor: '#10b981',
  },
  'lubricant-distribution': {
    description:
      'TENVO OILS is Pakistan’s leading engine oil & filter distribution network supplying Shell, Caltex, ZIC, PSO, TotalEnergies, Guard, Leppon, and Vic filters to wholesalers, workshops, lube shops, and commercial fleets.',
    city: 'Lahore',
    address: 'Daroghawala Industrial Area, GT Road',
    businessHours: 'Mon - Sat, 9:00 AM - 7:00 PM',
    freeShippingThreshold: 25000,
    returnPolicyDays: 7,
    announcement: '🛢️ TENVO OILS · Authorized Distributor for Shell, Caltex, ZIC, PSO & Guard Filters · Doorstep Van Delivery & Wholesale Credit',
    accentColor: '#d97706',
  },
  restaurant: {
    description:
  ...
  'construction-contractor': {
    description:
      'Consigli Construction Life Sciences & Civil Engineering: PEC C-A / C-1 licensed general contractor for turnkey pharmaceutical, commercial, and high-tech infrastructure.',
    city: 'Lahore',
    address: 'Industrial Zone Phase 3, Gulberg / Motorway M-2 Interchange, Lahore',
    phone: '+92 300 555 0199',
    email: 'construction@tenvo.pk',
    businessHours: 'Mon - Sat, 8:00 AM - 6:00 PM',
    freeShippingThreshold: 50000,
    returnPolicyDays: 30,
    announcement: 'Consigli At A Glance · Turnkey cGMP Cleanrooms & Civil Engineering · PEC Category C-A / C-1 Registered',
    accentColor: '#a71930',
    logo_url: '/tenvo-img/construction/construction-1.jpg',
    cover_image_url: '/tenvo-img/construction/construction-1.jpg',
    keywords:
      'construction contractor, PEC registered, civil engineering, cGMP cleanroom, BOQ materials, ASTM steel, RMC concrete, interim payment certificate',
    social: {
      facebook: '',
      instagram: '',
      linkedin: '',
    ...
    storefront: {
      construction: {
        profile: 'consigli-construction',
        tagline: 'Innovation starts with a dream and a plan',
        showTrustStrip: true,
        showMarketingBanners: true,
      },
    },
