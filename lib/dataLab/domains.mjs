...
export const DEMO_BUSINESS_PACK = [
  ...
  { key: 'ev-bikes', name: 'TENVO EV', domain: 'demo-ev', country: 'Pakistan', fullSeed: true },
  { key: 'lubricant-distribution', name: 'TENVO OILS', domain: 'demo-oil', country: 'Pakistan', fullSeed: true },
];
...
export const DEMO_SHOWCASE_PACK = [
  ...
  { key: 'construction-contractor', name: 'Tenvo Constructors', domain: 'demo-construction', country: 'Pakistan', fullSeed: true, showcase: true },
];
