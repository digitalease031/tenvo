...
export const pakistaniBrands = {
  ...
  clothing: [
    ...
    'Zellbury', 'Orient Textiles', 'Diners', 'HSY', 'Generation', 'Rang Ja', 'Saya',
    'Rang Ja', 'Ego', 'Republic by Omar Farooq',
  ],
  ...
  textile: [
    ...
    'Soorty Enterprises', 'Gul Ahmed Retail', 'Al-Karam Studio',
  ],
  ...
  designer: [
    ...
    'Sapphire (Luxury Pret)', 'Zellbury', 'Charcoal', 'Diners',
    'Republic by Omar Farooq', 'Misha Lakhani', 'Generation',
  ],
  ...
  // Construction materials, steel, cement, tiles & heavy equipment
  construction: [
    'Mughal Steel', 'Amreli Steels', 'Ittehad Steel', 'FF Steel', 'Agha Steel',
    'Bestway Cement', 'Maple Leaf Cement', 'Lucky Cement', 'Cherat Cement', 'DG Khan Cement',
    'Attock Petroleum', 'National Refinery (NRL)', 'Caterpillar', 'Komatsu', 'JCB', 'Foton', 'Millat Tractors',
