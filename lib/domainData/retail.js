...
export const retailDomains = {
    ...
    'garments': {
        icon: 'Shirt',
        imageUrl: '/retail_hero_image.png',
        productFields: ['Size/Color Matrix', 'Designer Tracking', 'Stitching Status', 'Season', 'Sourcing', 'Fabric Type', 'Collection Name'],
        ...
        fieldConfig: {
            ...
            stitchingstatus: { label: 'Stitching Status', type: 'select', options: ['Unstitched', 'Ready-to-Wear', 'Custom Stitched', 'Semi-Stitched'], required: true },
            season: { label: 'Season', type: 'select', options: ['Summer', 'Winter', 'Eid', 'Spring', 'Ramadan', 'Wedding', 'Bridal'], required: true },
            sourcing: {
                label: 'Sourcing',
                type: 'select',
            ...
            fabrictype: {
                label: 'Fabric Type',
                type: 'select',
                options: ['Lawn', 'Cotton', 'Wash & Wear', 'Chiffon', 'Silk', 'Khaddar', 'Linen', 'Denim', 'Karandi', 'Georgette', 'Cambric', 'Viscose', 'Net', 'Shamoz', 'Jacquard', 'Organza', 'Velvet'],
                required: false,
            },
            collectionname: { label: 'Collection Name', type: 'text', placeholder: 'e.g. Eid 2025 Collection', required: false },
        },
        customerFields: ['Size Preference', 'Favorite Designer', 'Stitching Measurements', 'Delivery City'],
        ...
        intelligence: {
            seasonality: 'high',
            // Eid ul-Fitr, Eid ul-Adha, wedding season, winter clearance, pre-Ramadan lawn
            peakMonths: ['March', 'April', 'May', 'June', 'July', 'November', 'December'],
            perishability: 'medium', // Fashion obsolescence
            shelfLife: 90, // Seasonal fashion cycle
            demandVolatility: 0.9,
            minOrderQuantity: 50,
            leadTime: 14,
            seasonalPeaks: ['Eid ul-Fitr', 'Eid ul-Adha', 'Winter Wedding Season', 'Summer Lawn Season'],
        },
        setupTemplate: {
    ...
    'water-delivery': {
        ...
        fieldConfig: {
            ...
            accountno: {
                label: 'Party Account No / Customer ID',
                type: 'text',
            ...
            deliveryroute: {
                label: 'Route / Rider',
                type: 'text',
                placeholder: 'e.g. BTK Precinct 1-10, Rider Ali',
                required: false,
                datalist: [
                    'BTK Precinct 1-10', 'BTK Precinct 11-20', 'BTK Precinct 27-31',
                    'BTK Sports City', 'BTK Bahria Heights / Apartments',
                    'BTK Jinnah Avenue', 'BTK Paradise', 'Bahria Town Karachi Main',
                    'DHA Phase 6 Route', 'DHA Phase 8 Route', 'Clifton Route',
                    'Gulshan Route', 'North Nazimabad Route', 'PECHS Route',
                    'Scheme 33 Route', 'Korangi Route',
                ],
            },
            deliverydays: {
                label: 'Delivery Days',
    ...
    'boutique-fashion': {
        icon: 'Palette',
        imageUrl: '/retail_hero_image.png',
        productFields: ['Designer', 'Collection', 'Fabric Type', 'Stitching Type', 'Article No', 'Design No', 'HSN Code'],
        ...
        fieldConfig: {
            ...
            collection: { label: 'Collection', type: 'select', options: ['Bridal', 'Luxury Pret', 'Casual', 'Evening Wear', 'Formal', 'Festive', 'Eid', 'Summer', 'Winter', 'Wedding Wear'], required: true },
            fabrictype: { label: 'Fabric Type', type: 'select', options: ['Silk', 'Chiffon', 'Organza', 'Velvet', 'Georgette', 'Lawn', 'Cotton', 'Karandi', 'Linen', 'Cambric', 'Viscose', 'Net', 'Shamoz', 'Jacquard', 'Wash & Wear'], required: true },
            ...
            articleno: { label: 'Article No', type: 'text', placeholder: 'e.g. BF-101', required: false },
            designno: { label: 'Design No', type: 'text', placeholder: 'e.g. D-205', required: false },
        },
        customerFields: ['Body Measurements (Shirt/Trouser/Dupatta)', 'Preferred Designer', 'Collection History', 'Stitching Lead Time Preference'],
        ...
        intelligence: {
            seasonality: 'high',
            // April-May (Eid ul-Fitr), June (Eid ul-Adha), Oct-Jan (wedding season peak)
            peakMonths: ['April', 'May', 'June', 'October', 'November', 'December', 'January'],
            // Muharram/Safar: cultural mourning period — minimal celebrations, low luxury fashion demand
            quietMonths: ['August', 'September'],
            quietNote: 'Muharram and Safar are months of mourning in the Islamic calendar. Celebrations and weddings are avoided, resulting in significantly lower demand for bridal and luxury pret.',
            perishability: 'medium',
            shelfLife: 90,
            demandVolatility: 0.9,
            minOrderQuantity: 1,
        ...
        setupTemplate: {
            categories: ['Bridal', 'Luxury Pret', 'Semi-Formal', 'Casual', 'Wedding Wear', 'Accessories', 'Unstitched Fabric'],
            suggestedProducts: [
                { name: '3 Piece Lawn Suit (Unstitched)', unit: 'set', category: 'Casual', startingStock: 20, defaultPrice: 4699, description: 'Summer lawn 3pc unstitched' },
                { name: 'Longline Lawn Kurta (Pret)', unit: 'pcs', category: 'Luxury Pret', startingStock: 15, defaultPrice: 4990, description: 'Ready-to-wear embroidered kurta' },
