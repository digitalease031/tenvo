export const specializedDomains = {
    'ev-bikes': {
        name: 'EV Bikes & Scooters',
        icon: 'Zap',
        imageUrl: '/tenvo-img/ev-hero-1.webp',
        productFields: [
            'Motor Serial', 'Battery Serial', 'Range (km)', 'Battery Type',
            'Motor Power (W)', 'Top Speed (km/h)', 'Charging Time',
            'Warranty Period', 'Brand',
        ],
        taxCategories: ['GST 18%'],
        units: ['unit', 'set', 'pcs', 'pack'],
        alternateUnits: { set: 'pcs' },
        defaultTax: 18,
        fieldConfig: {
            motorserial: { label: 'Motor Serial', type: 'text', placeholder: 'Motor serial number', required: true },
            batteryserial: { label: 'Battery Serial', type: 'text', placeholder: 'Lithium battery serial', required: true },
            rangekm: { label: 'Range (km)', type: 'text', placeholder: 'e.g. 100 km', required: false },
            batterytype: {
                label: 'Battery Type',
                type: 'select',
                options: ['Lithium-ion', 'LFP', 'Lead Acid', 'Removable Dual Battery'],
                required: false,
            },
            motorpower: { label: 'Motor Power', type: 'text', placeholder: 'e.g. 1500W, 3000W', required: false },
            topspeed: { label: 'Top Speed', type: 'text', placeholder: 'e.g. 85 km/h', required: false },
            chargingtime: { label: 'Charging Time', type: 'text', placeholder: 'e.g. 3 Hours', required: false },
            warrantyperiod: {
            ...
            brand: {
                label: 'Brand',
                type: 'select',
                options: ['Vlektra', 'Metro EV', 'Ramza Aima', 'Yadea', 'Crown EV', 'Other'],
                required: false,
            },
        },
        inventoryFeatures: [
            'Serial Number Tracking', 'Battery Serial Management', 'Test Ride Booking',
            'Installment / EMI Calculator', 'Warranty Claims', 'Multi-Location Showroom',
            'Barcode Scanning', 'Stock Valuation (FIFO)', 'Quotation Management', 'Challan Management'
        ],
        reports: [
            'EV Sales Report', 'Serial Number Ledger', 'Warranty Claims', 'Stock Summary',
            'Installment Ledger', 'Sales by Customer', 'Purchase Summary'
        ],
        setupTemplate: {
            categories: [
                'Electric Motorcycles', 'Urban EV Scooters', 'Long-Range Commuters',
                'High-Performance EV', 'Batteries & Chargers', 'Accessories & Spares',
            ],
            suggestedProducts: [],
        },
        paymentTerms: ['Cash', 'Bank Transfer', 'Installments (3 Mth)', 'Installments (6 Mth)', 'Installments (12 Mth)', 'Cheque'],
    ...
    'hardware-sanitary': {
        ...
        imageUrl: '/industrial_hero_image.png',
        productFields: [
            'Item Code', 'Material', 'Finish', 'Size', 'Gauge', 'Pcs per Box', 'Brand', 'Warranty',
        ],
        taxCategories: ['Sales Tax 18%', 'WHT 2%', 'FBR Standard'],
        units: ['pcs', 'set', 'pair', 'box', 'dozen', 'rft', 'sqft', 'kg', 'carton'],
        alternateUnits: { 'set': 'pcs', 'pair': 'pcs', 'box': 'pcs', 'dozen': 'pcs', 'carton': 'pcs' },
        defaultTax: 18,
        fieldConfig: {
            itemcode: { label: 'Item Code / Model', type: 'text', placeholder: 'e.g. 100606168 or MH-801', required: false },
            material: {
                label: 'Material',
                type: 'select',
                options: ['Stainless Steel SS 304', 'Stainless Steel SS 201', 'Solid Brass', 'Zinc Alloy (Zamac)', 'Aluminum', 'Mild Steel (Iron)', 'Tempered Glass', 'ABS Plastic'],
                required: false,
            },
            finish: {
                label: 'Finish / Color',
                type: 'select',
                options: ['Matt Black (MB)', 'Antique Brass (AB)', 'SS Satin / Brushed', 'Satin Nickel (SN)', 'Chrome Plated (CP)', 'PVD Gold', 'Rose Gold', 'Polished Brass (PB)', 'Dark Anthracite / Smoked'],
                required: false,
            },
            size: { label: 'Size / Dimension', type: 'text', placeholder: 'e.g. 4"x3"x3mm, 100mm, 450mm (18"), 85mm backset', required: false },
            gauge: { label: 'Gauge / Thickness', type: 'text', placeholder: 'e.g. 2.0mm, 2.5mm, 3.0mm, 16G', required: false },
            pcsperbox: { label: 'Pcs per Box', type: 'number', placeholder: 'e.g. 24 Pcs/Box, 10 Sets/Box', required: false },
            brand: {
                label: 'Brand',
                type: 'select',
                options: ['DTC', 'Blum', 'Philips', 'Roeasy', 'Unihopper', 'Martell', 'Anwer Architectural', 'VHID', 'Hafele', 'Yale', 'Stanley', 'Bosch', 'Crown', 'Master', 'Local / Generic'],
                required: false,
            },
            warranty: {
                label: 'Warranty / Guarantee',
                type: 'select',
                options: ['No Warranty', '1 Year Mechanism', '3 Years Mechanism', '5 Years Mechanism', '10 Years Finish Guarantee', 'Lifetime Warranty'],
                required: false,
            },
        },
        customerFields: ['Project Name', 'Contractor License', 'Site Delivery Address'],
        vendorFields: ['Manufacturer / Principal', 'Quality Certificate', 'Bulk Trade Discount %'],
        inventoryFeatures: [
            'Technical Hardware Specs', 'Box & Pcs Dual Conversion', 'Contractor Project Ledgers', 'Multi-Location Warehouses',
            'Barcode Scanning', 'Stock Valuation (FIFO / Average)', 'Reorder Points', 'Auto Reordering',
            'Quotation & Trade Discount', 'Sales Order Processing', 'Purchase Order Management', 'Delivery Challan Management',
            'FBR-Compliant Invoicing', 'Stock Transfer', 'Stock Adjustment', 'ABC Analysis',
            'Project Billings Report', 'Category & Finish Sales Share', 'Hardware Stock Alerts'
        ],
        reports: [
            'Project Billings Report', 'Finish & Material Sales Share', 'Box & Pcs Stock Valuation', 'Stock Summary',
            'Stock Movement', 'ABC Analysis', 'Fast/Slow Moving Items',
            'Stock Ledger', 'Sales by Category', 'Sales by Contractor'
        ],
        paymentTerms: ['Cash', 'Bank Transfer', 'Credit 15 Days', 'Credit 30 Days', 'Cheque', 'PDC Cheque'],
        stockValuationMethod: 'FIFO',
        reorderEnabled: true,
        multiLocationEnabled: true,
        serialTrackingEnabled: true,
        ...
        intelligence: {
            seasonality: 'medium',
            peakMonths: ['March', 'April', 'September', 'October'], // Peak construction & renovation months
            perishability: 'low',
            shelfLife: 3650,
            demandVolatility: 0.4,
            minOrderQuantity: 10,
        ...
        setupTemplate: {
            categories: [
                ...
                'Digital & Smart Locks',
                'Cabinet Fittings & Lift-Ups',
                'Glass Door Fittings',
                'Bathroom Hardware',
                'Power & Hand Tools',
            ],
            suggestedProducts: [
                { name: 'DTC C85B Hinge 3D Hydraulic (Soft-Close Half-Overlay)', unit: 'pcs', category: 'Hydraulic Hinges & Soft Close', startingStock: 250, defaultPrice: 480, description: '3D adjustable hydraulic soft-close concealed hinge' },
                { name: 'Philips 720MVP Palm Vein Smart Digital Lock', unit: 'set', category: 'Digital & Smart Locks', startingStock: 12, defaultPrice: 145000, description: 'Biometric palm vein smart lock with 3D facial recognition & video intercom' },
                { name: 'Martell Solid Brass Rose Handle Set (Antique Brass)', unit: 'set', category: 'Door Handles & Locks', startingStock: 40, defaultPrice: 16800, description: 'Heavy solid brass door handle pair with 85mm mortise lock body' },
                { name: 'DTC Tandembox Double Gallery Round Grey (18" / 450mm)', unit: 'set', category: 'Drawer Slides & Systems', startingStock: 30, defaultPrice: 14500, description: 'Double round gallery soft-close tandembox drawer system' },
                { name: 'Crown Heavy Duty 13mm Impact Drill 750W', unit: 'pcs', category: 'Power & Hand Tools', startingStock: 20, defaultPrice: 14500, description: '750W variable speed reversible impact drill with tool kit' },
            ]
        }
    },
    'poultry-farm': {
