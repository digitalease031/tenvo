export const textileDomains = {
    'textile-wholesale': {
        ...
        productFields: ['Article No', 'Design No', 'Fabric Type', 'Color/Shade', 'Kora/Finished', 'Width (Arz)', 'Thaan Length', 'Thaan Breakdown', 'Suit Cutting', 'Sourcing', 'Origin'],
        ...
        fieldConfig: {
            ...
            thaan_breakdown: { label: 'Thaan Breakdown (m)', type: 'text', placeholder: 'e.g. 30, 12, 45.5 (meters per roll)', required: false },
