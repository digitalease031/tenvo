      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: white;">
          ...
          <p style="color: #999; font-size: 14px; margin-top: 30px;">
            Questions? Contact us at support@tenvo.store
          </p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: white;">
          ...
          <p style="color: #999; font-size: 14px; margin-top: 30px;">
            Need help? Contact support@tenvo.store
          </p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: white;">
          ...
          <p style="color: #999; font-size: 14px; margin-top: 30px;">
            Questions? Reply to this email or contact support@tenvo.store
          </p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: white;">
          ...
          <p style="color: #999; font-size: 14px; margin-top: 30px;">
            Questions? Contact support@tenvo.store
          </p>
        </div>
