...
export const CANONICAL_DEMO_HEROES = Object.freeze({
  ...
  'demo-ev': 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=1200&q=80&auto=format&fit=crop',
  'demo-oil': 'https://images.unsplash.com/photo-1486262715619-67b85e44308f?w=1200&q=80&auto=format&fit=crop',
});
...
const GALLERY_OVERRIDES = {
  ...
  'demo-ev': {
    vertical: 'EV & Electric Bikes',
    marketingName: 'TENVO EV',
    icon: 'zap',
    backgroundColor: 'bg-gradient-to-br from-emerald-800 via-teal-950 to-neutral-950',
    glowGradient: '#10b981',
    glowColor: 'rgba(16, 185, 129, 0.4)',
  },
  'demo-oil': {
    vertical: 'Lubricant & Engine Oil',
    marketingName: 'Tenvo Lubricants',
    icon: 'droplets',
    backgroundColor: 'bg-gradient-to-br from-emerald-900 via-stone-900 to-black',
    glowGradient: '#059669',
