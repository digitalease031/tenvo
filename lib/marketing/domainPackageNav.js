...
const NAV_META = Object.freeze({
  ...
  'ev-bikes': { label: 'EV bikes & scooters', icon: 'Zap' },
  'construction-management': { label: 'Construction & EPC', icon: 'HardHat' },
  'lubricant-distribution': { label: 'Lubricant distribution', icon: 'Droplets' },
});
