...
import {
  ...
  EV_BIKES_COMMERCE_HIGHLIGHTS,
  CONSTRUCTION_MANAGEMENT_HIGHLIGHTS,
  LUBRICANT_DISTRIBUTION_HIGHLIGHTS,
...
export const DOMAIN_PACKAGE_SOLUTIONS_CONTENT = {
  ...
  'water-commerce': {
    ...
    channelPillars: [
      ...
      },
      {
        ...
        body: 'Rider doorstep grid filtered by weekday cadence. Save day once so week and month bills stay honest, with fuel and rider wage expense tracking.',
        accent: 'border-cyan-200/80 bg-gradient-to-br from-cyan-50/70 to-white',
  ...
  'ev-bikes': {
    heroEyebrow: 'EV & Electric Bike Suite',
    heroAccent: '#10b981',
    heroImage: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=1920&q=85&auto=format&fit=crop',
    audienceHeading: 'From EV showroom to national dealership network',
    audienceLead:
      'Manage Vlektra, Metro EV, Ramza Aima, and custom electric bike models with technical specs, lithium battery serial tracking, showroom POS, test-ride bookings, and online sales in one unified platform.',
    audience: [
      {
        title: 'EV Dealerships & Showrooms',
        body: 'Single or multi-branch electric bike showrooms with motor & battery serial tracking, trade-in valuations, counter POS, and customer installment ledgers.',
        fit: 'Best when you sell EV motorbikes/scooters and need VIN frame tracking, battery warranties, and showroom POS.',
      },
      {
        title: 'EV Manufacturers & Importers',
        body: 'Electric vehicle brands managing wholesale dealer networks, price lists, spare parts stock, fast-charger accessories, and after-sales service ledgers.',
        fit: 'Best when managing dealer price lists, bulk shipments, and warranty claim tracking.',
      },
    ],
    problemHeading: 'EV showrooms lose control when specs & serials are managed manually',
    problemLead:
      'Vehicle VINs, battery pack serials, test-ride appointments, and trade-in valuations often get lost in WhatsApp chats and paper registers.',
    painPoints: [
      {
        title: 'Battery warranty disputes',
        body: 'Without serial-level tracking, verifying lithium battery pack age, warranty claims, and replacement history becomes a costly headache.',
      },
      {
        title: 'Unorganized test rides',
        body: 'Prospective buyers visiting your website have no easy way to schedule showroom test rides, leading to lost leads.',
      },
      {
        title: 'Missing EV spec display',
        body: 'Standard e-commerce themes hide critical EV buyer specs like battery voltage, motor power (W), range (km), and charging time.',
      },
      {
        title: 'Trade-in estimation friction',
        body: 'Evaluating petrol bike trade-ins and applying credits toward new EV purchases without a central ledger creates accounting errors.',
      },
    ],
    outcomesHeading: 'How TENVO transforms electric mobility commerce',
    outcomesLead:
      'Concrete operational benefits: serial-backed battery warranties, automated test-ride leads, and a high-converting EV storefront on day one.',
    outcomes: [
      {
        metric: '100% serials',
        label: 'VIN & Battery traceability',
        body: 'Frame VIN numbers and battery pack serials attach automatically to sales invoices and warranty ledgers.',
      },
      {
        metric: 'Instant specs',
        label: 'Range, speed & battery pills',
        body: 'Product cards and detail pages showcase motor power, range in km, top speed, and charging time clearly.',
      },
      {
        metric: 'Test-ride leads',
        label: 'Integrated booking CTA',
        body: 'Website visitors can book showroom test rides directly, sending instant leads to your sales team.',
      },
    ],
    guideHeading: 'Launch your EV store in three steps',
    guideLead:
      'Select your EV brand preset (Vlektra, Metro EV, Ramza, or Custom EV Showroom), register with Business packaging, and launch your store.',
    guideSteps: [
      {
        title: 'Choose your EV brand preset',
        body: 'Pre-loaded catalog items for Vlektra, Metro EV, and Ramza Aima with real prices, technical specs, and high-res imagery.',
      },
      {
        title: 'Register the suite',
        body: 'Start trial with ev-bikes packaging at PKR 14,999/mo ($49/mo) with full POS, serial tracking, and storefront features enabled.',
        href: '/register?package=ev-bikes&domain=ev-bikes&plan=business',
        cta: 'Start EV Commerce Suite',
      },
    ],
    channelPillars: [
      {
        icon: 'Zap',
        title: 'EV Motor & Battery Specs',
        body: 'Range (km), top speed (km/h), motor power (W), battery type (Lithium/Graphene), and charging time displayed on cards & PDP.',
        accent: 'border-emerald-200/80 bg-gradient-to-br from-emerald-50/70 to-white',
        iconClass: 'bg-emerald-600 text-white',
        slideAccent: '#10b981',
      },
      {
        icon: 'ShieldCheck',
        title: 'VIN & Battery Serial Ledger',
        body: 'Track individual frame VINs, battery pack serials, warranty dates, and after-sales service records with complete audit trails.',
        accent: 'border-teal-200/80 bg-gradient-to-br from-teal-50/70 to-white',
      ...
      {
        icon: 'Calendar',
        title: 'Test-Ride Booking & Showroom POS',
        body: 'Online test-ride appointment scheduling combined with fast counter POS for deposits, vehicles, chargers, and spare parts.',
        accent: 'border-green-200/80 bg-gradient-to-br from-green-50/70 to-white',
        iconClass: 'bg-green-600 text-white',
        slideAccent: '#059669',
      },
    ],
    verticalPresets: [
      { key: 'vlektra', label: 'Vlektra Electric Motorcycles', desc: 'High-performance café racer & naked sport EV bikes' },
      { key: 'metroev', label: 'Metro EV Scooters', desc: 'Best-selling urban smart scooters & long-range commuters' },
      { key: 'ramza', label: 'Ramza Aima E-Bikes', desc: 'Fashion-forward urban mobility with Azure Controllers' },
      { key: 'tenvo-ev', label: 'Tenvo EV Showroom', desc: 'Multi-brand EV dealership & battery service station' },
    ],
    highlightFeatures: EV_BIKES_COMMERCE_HIGHLIGHTS,
    faqTitle: 'EV & Electric Bike Commerce Suite FAQ',
    ctaTitle: 'Run your EV dealership on one powerful platform — PKR 14,999/mo',
    ctaSubtitle:
      '14-day trial on Business modules with EV presets, VIN serial tracking, test-ride bookings, and showroom POS.',
  },
  'construction-management': {
    heroEyebrow: 'Construction & Infrastructure EPC Suite',
    heroLead:
      'Integrated BOQ cost analysis, Interim Payment Certificate (IPC) running bills, NHA/MRS rate schedules, retention money ledgers, site machinery hour-meter logs, and subcontractor accounts. Built for contractors and civil engineering firms in Pakistan.',
    heroAccent: '#a71930',
    heroImage: 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1920&q=85&auto=format&fit=crop',
    audienceHeading: 'From site contractors to multi-million infrastructure EPC firms',
    audienceLead:
      'Manage public sector tenders (PEC / PPRA / NHA / CWD) and private commercial projects with BOQ rate schedules, running bills, retention money, and site machinery tracking without spreadsheet chaos.',
    audience: [
      {
        title: 'Building & Civil Contractors',
        body: 'Track itemized BOQ rate analysis, site warehouse material transfers, subcontractor work orders, and provincial WHT deductions.',
        fit: 'Best for general contractors managing multiple sites, site gate passes, and running bills.',
      },
      {
        title: 'Infrastructure & EPC Firms',
        body: 'PEC Clause 70 Price Adjustment formulas, heavy machinery hour-meter logbooks, diesel fuel tracking, and Mobilization Advance amortization.',
        fit: 'Best for road, highway, bridge, and industrial infrastructure projects.',
      },
    ],
    problemHeading: 'Construction projects lose profit when BOQs and site bills are tracked in spreadsheets',
    problemLead:
      'Material price hikes, retention money disputes, unverified subcontractor claims, and machinery fuel leaks bleed margins when project data is disconnected.',
    painPoints: [
      {
        title: 'IPC running bill delay',
        body: 'Manual IPC calculation with Mobilization Advance, Retention Money (5-10%), and Clause 70 price escalation takes days and causes billing disputes.',
      },
      {
        title: 'BOQ rate variance',
        body: 'Steel, cement, and bitumen rate fluctuations destroy estimated margins when actual site consumption is not tracked against original BOQs.',
      },
      {
        title: 'Machinery fuel leakage',
        body: 'Heavy equipment hour-meters and diesel consumption in Liters/Hour go untracked without site machinery logbooks.',
      },
      {
        title: 'Tax & retention confusion',
        body: 'FBR Sec 153 WHT and Provincial PRA/SRB/KPRA WHT deductions on running bills create tax ledger discrepancies.',
      },
    ],
    outcomesHeading: 'How TENVO empowers construction and engineering teams',
    outcomesLead:
      'Real-time BOQ variance tracking, automated IPC running bill creation, and site machinery audit trails.',
    outcomes: [
      {
        metric: '100% IPC',
        label: 'Running Bill Accuracy',
        body: 'Interim Payment Certificates compute cumulative work done, retention deductions, and WHT withholding automatically.',
      },
      {
        metric: 'BOQ vs Site',
        label: 'Live Material Variance',
        body: 'Track Grade 60 rebar, cement, and aggregate consumption against Schedule of Rates (Punjab MRS / NHA CSR).',
      },
      {
        metric: 'Machinery logs',
        label: 'Fuel & Hour-meter Control',
        body: 'Log excavator, grader, and paver hour-meters with diesel consumption rates per site.',
      },
    ],
    guideHeading: 'Launch your Construction project hub in three steps',
    guideLead:
      'Select your contractor category (Civil, Building, Infrastructure), register with Enterprise packaging, and import your BOQs.',
    guideSteps: [
      {
        title: 'Choose your PEC contractor preset',
        body: 'Pre-loaded rate schedules (MRS / CSR / SPPRA DRC) and BOQ templates for building, road, and infrastructure projects.',
      },
      {
        title: 'Register the suite',
        body: 'Start trial with construction-management packaging at PKR 24,999/mo ($89/mo) with IPC billing, BOQs, and site machinery tracking.',
        href: '/register?package=construction-management&domain=construction-contractor&plan=enterprise',
        cta: 'Start Construction Suite',
      },
    ],
    channelPillars: [
      {
        icon: 'Calculator',
        title: 'BOQ & Composite Rate Analysis',
        body: 'Itemized BOQ breakdown with Material, Labor, and Equipment cost analysis based on Punjab MRS and Federal CSR rate schedules.',
        accent: 'border-red-200/80 bg-gradient-to-br from-red-50/70 to-white',
        iconClass: 'bg-red-600 text-white',
        slideAccent: '#a71930',
      },
      {
        icon: 'FileText',
        title: 'IPC Running Bills & Retention Ledgers',
        body: 'Interim Payment Certificate workflow with Mobilization Advance recovery, 5-10% Retention Money tracking, and PEC Clause 70 price escalation.',
        accent: 'border-zinc-200/80 bg-gradient-to-br from-zinc-50/70 to-white',
        iconClass: 'bg-zinc-800 text-white',
        slideAccent: '#27272a',
      },
      {
        icon: 'Truck',
        title: 'Site Machinery & Material Inventory',
        body: 'Site warehouse Gate Passes, heavy equipment hour-meter logbooks, diesel fuel monitoring, and subcontractor running accounts.',
        accent: 'border-amber-200/80 bg-gradient-to-br from-amber-50/70 to-white',
        iconClass: 'bg-amber-700 text-white',
        slideAccent: '#d97706',
      },
    ...
    verticalPresets: [
      { key: 'construction-contractor', label: 'General Construction Contractor', desc: 'BOQs, IPC running bills, retention ledgers, site transfers' },
      { key: 'civil-engineering', label: 'Civil Engineering & Infrastructure', desc: 'NHA/MRS rate schedules, Clause 70 escalation, heavy machinery logs' },
      { key: 'building-construction', label: 'Building & Housing Construction', desc: 'Subcontractor ledgers, material gate passes, project costing' },
      { key: 'road-infrastructure', label: 'Road & Highway Infrastructure', desc: 'Bitumen/aggregate tracking, equipment yield, IPC certification' },
    ],
    highlightFeatures: CONSTRUCTION_MANAGEMENT_HIGHLIGHTS,
    faqTitle: 'Construction & EPC Suite FAQ',
    ctaTitle: 'Run your construction projects on one unified ERP — PKR 24,999/mo',
    ctaSubtitle:
      '14-day trial on Enterprise modules with BOQ rate analysis, IPC running bills, site machinery logs, and FBR/Provincial WHT compliance.',
  },
  'lubricant-distribution': {
    heroEyebrow: 'Lubricant & Engine Oil Distribution Suite (LDMS)',
    heroLead:
      'Complete operating system for lubricant distributors, wholesalers, and mobilers in Pakistan. Manage viscosity grades, carton-to-bottle conversion, mobile van sales, beat routes, credit limit enforcement, and principal rebate claims.',
    heroAccent: '#059669',
    heroImage: 'https://images.unsplash.com/photo-1486262715619-67b85e44308f?w=1920&q=85&auto=format&fit=crop',
    audienceHeading: 'Engineered for Shell, Caltex, Total, ZIC, and PSO oil distributors',
    audienceLead:
      'Distributors selling engine oil in cartons and bottles across cities and territory beat routes get automated packaging conversions, van stock reconciliation, and credit control in one hub.',
    audience: [
      {
        title: 'Lubricant Distributors & Wholesalers',
        body: 'Track multi-unit packaging (Cartons -> Bottles -> Liters), API/ACEA technical specs, workshop price lists, and Post-Dated Cheques (PDCs).',
        fit: 'Best for authorized oil company distributors managing large warehouse inventory and dealer networks.',
      },
      {
        title: 'Mobile Van Sales & Mobilers',
        body: 'Issue van stock transfers, perform daily beat route sales, print thermal invoices on customer visits, and reconcile van stock variances at end-of-day.',
        fit: 'Best for sales teams running field van delivery and instant cash/credit collection.',
      },
    ],
    problemHeading: 'Oil distributors bleed profit when carton conversions and van sales are manual',
    problemLead:
      'Selling engine oil in cartons while reporting in liters, untracked van stock variances, unauthorized credit limit extensions, and uncollected PDCs destroy distributor margins.',
    painPoints: [
      {
        title: 'Carton to liter conversion math',
        body: 'Manually converting 1L, 4L, and 20L bottles to cartons and total liters across invoices creates inventory errors.',
      },
      {
        title: 'Van stock leaks',
        body: 'Salesmen carrying stock in delivery vans without EOD physical vs expected reconciliation lead to untracked stock losses.',
      },
      {
        title: 'Credit limit violations',
        body: 'Over-crediting workshops without real-time projected balance enforcement results in bad debts and overdue 90+ day aging.',
      },
      {
        title: 'Unclaimed principal schemes',
        body: 'Failing to track monthly sales targets, volume schemes (e.g. Buy 10 Get 1 Free), and oil company rebate claims costs millions.',
      },
    ],
    outcomesHeading: 'How TENVO LDMS powers oil distribution operations',
    outcomesLead:
      'Automated unit conversion engine, real-time credit enforcement, van reconciliation, and principal scheme ledgers.',
    outcomes: [
      {
        metric: 'Carton → Liter',
        label: 'Auto Unit Conversion',
        body: 'Receive in cartons, sell in bottles or cartons, and view stock in Liters automatically.',
      },
      {
        metric: 'Van Sales',
        label: 'Daily EOD Reconciliation',
        body: 'Reconcile physical vs system van stock daily with variance tracking before loading the next beat route.',
      },
      {
        metric: 'Credit Control',
        label: 'Projected Balance & PDC',
        body: 'Block invoices automatically when customer credit limits or PDC dates are exceeded.',
      },
    ],
    guideHeading: 'Launch your Lubricant Distribution OS in three steps',
    guideLead:
      'Select your oil principal preset (Shell, Caltex, ZIC, PSO, or Multi-Brand), register with Business packaging, and start van sales.',
    guideSteps: [
      {
        title: 'Select your principal brand preset',
        body: 'Pre-loaded oil technical specs (SAE 20W-50, 10W-40, 5W-30, API SP/CK-4) and Pakistani oil packaging configurations.',
      },
      {
        title: 'Register the suite',
        body: 'Start trial with lubricant-distribution packaging at PKR 14,999/mo ($55/mo) with full van sales, multi-unit stock, and credit control enabled.',
        href: '/register?package=lubricant-distribution&domain=lubricant-distribution&plan=business',
        cta: 'Start LDMS Suite',
      },
    ],
    channelPillars: [
      {
        icon: 'Layers',
        title: 'Technical Master & Multi-Unit Conversion',
        body: 'Viscosity grades, API/ACEA specs, OEM approvals, and automatic Carton-to-Bottle-to-Liter unit conversion engine.',
        accent: 'border-emerald-200/80 bg-gradient-to-br from-emerald-50/70 to-white',
        iconClass: 'bg-emerald-600 text-white',
        slideAccent: '#059669',
      },
      {
        icon: 'Truck',
        title: 'Van Sales & Route Management',
        body: 'Mobile van inventory, territory beat routes, doorstep invoice printing, and daily end-of-day van stock variance reconciliation.',
        accent: 'border-blue-200/80 bg-gradient-to-br from-blue-50/70 to-white',
        iconClass: 'bg-blue-600 text-white',
        slideAccent: '#2563eb',
      },
      {
        icon: 'ShieldAlert',
        title: 'Credit Limit Enforcement & Principal Schemes',
        body: 'Projected credit limit checking, 30/60/90+ day aging buckets, Post-Dated Cheques (PDC), and oil company target rebate claims.',
        accent: 'border-amber-200/80 bg-gradient-to-br from-amber-50/70 to-white',
    ...
    verticalPresets: [
      { key: 'shell-distributor', label: 'Shell Lubricants Distributor', desc: 'Commercial & passenger motor oils distributor' },
      { key: 'caltex-distributor', label: 'Caltex Havoline Distributor', desc: 'Wholesaler & mobiler distribution network' },
      { key: 'zic-distributor', label: 'ZIC SK Lubricants Distributor', desc: 'Synthetic motor oils & gear lubricants' },
      { key: 'pso-distributor', label: 'PSO Lubricants Distributor', desc: 'Carient & Deo diesel engine oil distribution' },
    ],
    highlightFeatures: LUBRICANT_DISTRIBUTION_HIGHLIGHTS,
    faqTitle: 'Lubricant & Engine Oil Distribution Suite FAQ',
    ctaTitle: 'Run your oil distribution network on TENVO LDMS — PKR 14,999/mo',
    ctaSubtitle:
      '14-day trial on Business modules with oil presets, carton conversion, van sales reconciliation, and credit limit enforcement.',
  },
};
