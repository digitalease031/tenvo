...
export const REGISTRATION_RICH_CATALOG_VERTICALS = new Set([
  ...
  'electronics-goods',
  /** Construction contractor — BOQ materials, plant equipment, labor seed on day one. */
  'construction-contractor',
  /** EV Bikes & Scooters showroom catalog on day one. */
  'ev-bikes',
  /** Lubricant & engine oil distribution seed catalog on day one. */
  'lubricant-distribution',
  /** Hardware & architectural fittings seed catalog on day one. */
  'hardware-sanitary',
]);
...
export const PACKAGE_RICH_CATALOG_VERTICALS = new Map([
  ...
  ['construction-management', new Set(['construction-contractor'])],
  ['ev-bikes', new Set(['ev-bikes'])],
  ['lubricant-distribution', new Set(['lubricant-distribution'])],
  ['hardware-commerce', new Set(['hardware-sanitary'])],
]);
