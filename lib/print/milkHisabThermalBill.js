...
export function buildDailyRouteSummaryHtml(model) {
  ...
  @media print {
    ...
    body { width: ${PW_PX}px !important; max-width: ${PW_PX}px !important; margin: 0 !important; padding: 2mm 1.5mm 3mm !important; }
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  thead th { font-weight: 700; border-bottom: 1px solid #333; padding: 0.8mm 0.5mm; text-align: center; }
  tbody td { padding: 0.8mm 0.5mm; text-align: center; border-bottom: 1px dotted #ddd; }
...
export function buildMilkHisabDayBreakdownHtml(model) {
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .row { display: flex; justify-content: space-between; align-items: baseline; gap: 0.5mm; font-size: ${isUrdu ? '8px' : '7px'}; padding: 0.2mm 0; direction: ltr; }
