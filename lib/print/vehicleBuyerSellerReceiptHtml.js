...
export function resolveVehicleAgreementDetails(invoice = {}, business = {}) {
  ...
  if (transactionMode === 'installment') title = 'VEHICLE INSTALLMENT SALE & LEASE AGREEMENT';
  ...
  return {
    ...
    employmentType: agreement.employmentType || 'salaried',
    employerName: agreement.employerName || '',
    monthlyIncome: agreement.monthlyIncome || '',
    downPaymentPct: agreement.downPaymentPct ?? 20,
    downPaymentAmount: agreement.downPaymentAmount || '',
    durationMonths: agreement.durationMonths ?? 24,
    markupPct: agreement.markupPct ?? 15,
    monthlyInstallment: agreement.monthlyInstallment || '',
    ...
    witness1Relation: agreement.witness1Relation || '',
    witness1City: agreement.witness1City || '',
    witness2Name: agreement.witness2Name || '',
    witness2Cnic: agreement.witness2Cnic || '',
    witness2Phone: agreement.witness2Phone || '',
    witness2Relation: agreement.witness2Relation || '',
    witness2City: agreement.witness2City || '',
