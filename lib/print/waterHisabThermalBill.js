...
export function buildWaterDailySaleHtml(model) {
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .row span.lbl { text-align: left; padding-right: 3px; flex: 1; }
...
export function buildWaterPeriodBillHtml(model) {
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .row { display: flex; justify-content: space-between; align-items: baseline; gap: 1mm; font-size: 7px; padding: 0.2mm 0; }
