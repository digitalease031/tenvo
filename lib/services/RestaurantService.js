...
export const RestaurantService = {
    ...
    async createOrder(data, userId, txClient = null) {
        ...
        try {
            ...
            // Generate daily token number (resets every day) with safe fallback if column missing
            let tokenNumber = null;
            let hasTokenCol = true;
            try {
                ...
                `, [data.businessId]);
                tokenNumber = parseInt(tokenRes.rows[0]?.next_token || 1, 10);
            } catch (tokErr) {
                if (tokErr.code === '42703') { // Column does not exist
            ...
            if (hasTokenCol) {
                res = await client.query(`
                    INSERT INTO restaurant_orders (
                        business_id, order_number, token_number, table_id, order_type,
                        customer_id, waiter_id, status,
                        subtotal, tax_amount, discount_amount, total_amount, notes
                    ) VALUES ($1, $2, $3, $4, $5, $6, $7, 'pending', $8, $9, $10, $11, $12)
                    RETURNING *
                `, [
                    data.businessId, orderNumber, tokenNumber, data.tableId, data.orderType,
