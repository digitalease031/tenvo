...
export const CANONICAL_HERO_VARIANTS = {
  ...
  'construction-contractor': {
    slides: [
      {
        title: 'CONSIGLI AT A GLANCE - LIFE SCIENCES & HEAVY CIVIL',
        subtitle: 'Innovation starts with a dream and a plan. Quality construction management & turnkey execution.',
        image: '/tenvo-img/construction/construction-1.jpg',
      },
      {
        title: 'VIRTUAL DESIGN & CONSTRUCTION (VDC)',
        subtitle: 'Building Data Models, BIM coordination, and 3D pre-construction planning.',
        image: '/tenvo-img/construction/service2.jpg',
      },
      {
        title: 'AFFORDABLE HOUSING & INFRASTRUCTURE',
        subtitle: 'PEC C-A / C-1 registered general contractor for commercial, industrial & public sector BOQ projects.',
        image: '/tenvo-img/construction/affordable.jpg',
      },
    ],
    shortcuts: [
      { id: 'precon', label: 'Preconstruction', slug: 'civil-structural', icon: 'wrench' },
      { id: 'vdc', label: 'Virtual Construction', slug: 'vdc-bim', icon: 'zap' },
      { id: 'projects', label: 'Featured Projects', slug: 'projects', icon: 'package' },
      { id: 'contact', label: 'Get in Touch', slug: '', icon: 'phone', href: 'contact' },
    ],
    searchPlaceholder: 'Search BOQ items, Grade 60 rebar, OPC cement, RMC mix, machinery…',
    trendingTerms: ['Grade 60 Rebar', 'OPC Cement', 'RMC Concrete', 'IPC Bill', 'Site Fuel'],
  },
  'solar-energy': {
    slides: [
      {
