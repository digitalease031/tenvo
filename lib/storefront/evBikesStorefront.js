...
/**
 * Return 9 standardized EV comparison spec rows matching Tenvo EV specification structure.
 * @param {object} product
...
/**
 * Navigation links tailored for EV Bikes & Scooters showroom storefront.
 * @param {string} storeRoot
 * @returns {Array<{ id: string, label: string, href: string }>}
 */
export function getEvBikesNavLinks(storeRoot) {
  return [
    { id: 'home', label: 'Home', href: storeRoot },
    { id: 'lineup', label: 'EV Lineup', href: `${storeRoot}/products` },
    { id: 'pave', label: 'PAVE Scheme', href: `${storeRoot}/products?category=pave` },
    { id: 'installments', label: 'Installments', href: `${storeRoot}/installments` },
    { id: 'compare', label: 'Compare Models', href: `${storeRoot}#compare` },
    { id: 'calculator', label: 'Savings Calculator', href: `${storeRoot}#calculator` },
  ];
}
