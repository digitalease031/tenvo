...
const HARDWARE_HERO_SLIDES = [
  {
    eyebrow: 'Architectural Fittings',
    title: 'Luxury Door Handles & Solid Brass Locks',
    subtitle: 'Solid brass rose handles, mortise locks, entrance pulls, and premium door fittings.',
    image: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=1600&q=82&auto=format&fit=crop',
  },
  {
    eyebrow: 'Smart Security',
    title: 'Biometric Palm & Fingerprint Digital Locks',
    subtitle: 'Philips 3D facial recognition, palm vein smart locks, and deadbolts.',
    image: 'https://images.unsplash.com/photo-1558002038-1055907df827?w=1600&q=82&auto=format&fit=crop',
  },
  {
    eyebrow: 'Kitchen Hardware',
    title: 'DTC & Blum Tandembox & Hydraulic Hinges',
    subtitle: '3D soft-close hydraulic hinges, tandembox drawer systems, and cabinet lift-ups.',
    image: 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?w=1600&q=82&auto=format&fit=crop',
  },
  {
    eyebrow: 'Trade & Contractor Accounts',
    title: 'Bulk Pricing & Contractor Discounts',
    subtitle: 'Special wholesale rates, staged project billings, and delivery challans.',
    image: 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=1600&q=82&auto=format&fit=crop',
  },
];

const HARDWARE_CATEGORY_SHORTCUTS = [
  { id: 'handles', label: 'Door Handles', slug: 'door-handles-locks', icon: 'key' },
  { id: 'hinges', label: 'Hydraulic Hinges', slug: 'hydraulic-hinges-soft-close', icon: 'wrench' },
  { id: 'slides', label: 'Drawer Slides', slug: 'drawer-slides-systems', icon: 'package' },
  { id: 'smart-locks', label: 'Digital Locks', slug: 'digital-smart-locks', icon: 'lock' },
  { id: 'cabinet', label: 'Cabinet Fittings', slug: 'cabinet-fittings-lift-ups', icon: 'grid' },
  { id: 'tools', label: 'Power Tools', slug: 'power-hand-tools', icon: 'zap' },
];
...
function buildHeroPreset(category, businessDomain, settings = {}, business = {}) {
  ...
  if (vertical === 'hardware-parts' || canonical === 'auto-parts' || canonical === 'hardware-sanitary') {
    const isAuto = isAutoPartsFinderStore(canonical);
    const slides = isAuto
      ? getAutoPartsHeroSlides(base, settings, customCover)
      : HARDWARE_HERO_SLIDES.map((s, i) => (i === 0 && customCover ? { ...s, image: customCover } : s));
    ...
    return {
      ...
      categoryShortcuts: shortcuts,
      brands: isAuto
        ? AUTO_PARTS_SHOP_BRANDS.slice(0, 12)
        : ['DTC', 'Blum', 'Philips', 'Roeasy', 'Unihopper', 'Martell', 'Anwer', 'Hafele', 'Yale', 'Stanley', 'Bosch', 'Crown'],
      accentLabel: isAuto ? 'Auto Parts' : 'Hardware & Fittings',
    };
  }
