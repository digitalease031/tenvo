...
export function normalizeStorefrontRemoteImageUrl(url) {
  const rawUrl = typeof url === 'string' ? url : (typeof url?.url === 'string' ? url.url : (typeof url?.src === 'string' ? url.src : ''));
  ...
  let cleaned = raw;
  if (cleaned.includes('–')) {
    cleaned = cleaned.replace(/–/g, '%E2%80%93');
  }
  if (cleaned.startsWith('http://revoo-ev.com.pk/')) {
    cleaned = cleaned.replace('http://', 'https://');
  }
  if (cleaned.startsWith('http://metroev.pk/')) {
    cleaned = cleaned.replace('http://', 'https://');
  }
  return cleaned;
}
...
const POOL = {
  ...
  'ev-bikes': [
    cardUrl('https://images.unsplash.com/photo-1558981403-c5f9899a28bc'),
    cardUrl('https://images.unsplash.com/photo-1568772585407-9361f9bf3a87'),
    cardUrl('https://images.unsplash.com/photo-1571188654248-7a89213915f7'),
    cardUrl('https://images.unsplash.com/photo-1558981806-ec527fa84c39'),
    cardUrl('https://images.unsplash.com/photo-1558980394-4c7c9299fe96'),
  ],
  hardware: [
    cardUrl('https://images.unsplash.com/photo-1513694203232-719a280e022f'),
    cardUrl('https://images.unsplash.com/photo-1558002038-1055907df827'),
    cardUrl('https://images.unsplash.com/photo-1556911220-e15b29be8c8f'),
    cardUrl('https://images.unsplash.com/photo-1581092160562-40aa08e78837'),
    cardUrl('https://images.unsplash.com/photo-1504148455328-c376907d081c'),
    cardUrl('https://images.unsplash.com/photo-1584622650111-993a426fbf0a'),
  ],
...
const NAME_RULES = [
  ...
  { test: (n) => /\b(door handle|handle|mortise|lock|hinge|tandembox|legrabox|slide|pull handle|deadbolt|patch fitting|hardware)\b/.test(n), urls: POOL.hardware },
...
const VERTICAL_POOLS = {
  ...
  'hardware-parts': [...POOL.hardware, ...POOL.tools, ...POOL.plumbing],
  'hardware-sanitary': [...POOL.hardware, ...POOL.tools, ...POOL.plumbing],
