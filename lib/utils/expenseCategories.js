...
const DEFAULT_COLORS = Object.freeze({
  ...
  dyeing_printing: 'bg-purple-100 text-purple-800',
  carriage_freight: 'bg-emerald-100 text-emerald-800',
  packing_bale: 'bg-amber-100 text-amber-800',
  agent_commission: 'bg-indigo-100 text-indigo-800',
  generator_fuel: 'bg-rose-100 text-rose-800',
  daily_wages: 'bg-wine-100 text-wine-800',
  stitching_jobwork: 'bg-cyan-100 text-cyan-800',
});
...
const DOMAIN_OVERLAYS = Object.freeze({
  ...
  'textile-wholesale': [
    { value: 'dyeing_printing', label: 'Dyeing / Printing / Processing', account_code: ACCOUNT_CODES.MISCELLANEOUS },
    { value: 'carriage_freight', label: 'Freight & Carriage (Bilti / Transport)', account_code: ACCOUNT_CODES.LOGISTICS },
    { value: 'packing_bale', label: 'Bale & Packaging Materials', account_code: ACCOUNT_CODES.OFFICE_SUPPLIES },
    { value: 'agent_commission', label: 'Broker / Agent Commission', account_code: ACCOUNT_CODES.PROFESSIONAL_FEES },
    { value: 'generator_fuel', label: 'Generator & Utilities Fuel', account_code: ACCOUNT_CODES.UTILITIES },
    { value: 'daily_wages', label: 'Daily Wages / Labor (Mazdoori)', account_code: ACCOUNT_CODES.SALARIES },
  ],
  garments: [
    { value: 'stitching_jobwork', label: 'Stitching & Job Work', account_code: ACCOUNT_CODES.MISCELLANEOUS },
    { value: 'dyeing_printing', label: 'Printing & Embroidery', account_code: ACCOUNT_CODES.MISCELLANEOUS },
    { value: 'carriage_freight', label: 'Freight & Carriage (Bilti)', account_code: ACCOUNT_CODES.LOGISTICS },
    { value: 'packaging', label: 'Tags, Hangers & Shoppers', account_code: ACCOUNT_CODES.OFFICE_SUPPLIES },
    { value: 'daily_wages', label: 'Daily Wages / Labor (Mazdoori)', account_code: ACCOUNT_CODES.SALARIES },
  ],
  'lubricant-distribution': [
    { value: 'delivery_van_fuel', label: 'Delivery Van & Vehicle Fuel', account_code: ACCOUNT_CODES.LOGISTICS },
    { value: 'vehicle_maintenance', label: 'Van & Fleet Maintenance (Tyres/Oil/Repairs)', account_code: ACCOUNT_CODES.REPAIRS },
    { value: 'driver_allowance', label: 'Driver & Salesman Mileage / Allowance', account_code: ACCOUNT_CODES.TRAVEL },
    { value: 'loading_unloading', label: 'Loading & Unloading Labor (Mazdoori)', account_code: ACCOUNT_CODES.SALARIES },
    { value: 'carriage_freight', label: 'Inter-City Freight & Bilti', account_code: ACCOUNT_CODES.LOGISTICS },
    { value: 'warehouse_godown_rent', label: 'Main Warehouse & Godown Rent', account_code: ACCOUNT_CODES.RENT },
    { value: 'principal_claim_expense', label: 'Promotional & Scheme Expense', account_code: ACCOUNT_CODES.MARKETING },
  ],
});
...
const OVERLAY_ALIASES = Object.freeze({
  ...
  'textile-mill': 'textile-wholesale',
...
const SHOP_LABELS = Object.freeze({
  ...
  dyeing_printing: 'Dyeing / printing / processing',
  carriage_freight: 'Freight & carriage (Bilti)',
  packing_bale: 'Bale & packing materials',
  agent_commission: 'Broker / agent commission',
  generator_fuel: 'Generator fuel',
  daily_wages: 'Daily labor (Mazdoori)',
  stitching_jobwork: 'Stitching & job work',
});
