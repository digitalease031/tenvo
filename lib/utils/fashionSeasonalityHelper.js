...
export const FASHION_SEASONAL_PERIODS = [
  ...
  {
    // Peak Pakistan summer lawn season — high volume Lawn/Chiffon/Cotton/Linen demand
    name: 'Summer Lawn Season',
    startMonth: 4, // April
    endMonth: 6, // June
    demandMultiplier: 1.8,
    categories: ['Lawn', 'Chiffon', 'Cotton', 'Linen', 'Summer Collection', 'Light Fabrics'],
    insight: 'Peak lawn season in Pakistan. Lawn, chiffon, and cotton fabrics see the highest annual volume. Pre-book 4-6 weeks before April.'
  },
  {
    // Pakistan winter wedding season — bridal fabrics at maximum demand
    name: 'Bridal Wedding Season',
    startMonth: 10, // October
    endMonth: 1, // January (wraps to next year)
    demandMultiplier: 3.0, // 200% increase
    categories: ['Bridal Collection', 'Formal', 'Chiffon', 'Silk', 'Organza', 'Velvet', 'Georgette', 'Karandi', 'Embroidered', 'Mens Wear'],
    insight: 'Peak wedding season in Pakistan. Bridal and luxury formals see highest demand. Pre-orders start in September.'
  },
  {
...
export function getFashionSeasonalInsights(domainKey) {
  ...
  if (next.shouldPrepare && next.nextPeriod) {
    recommendations.push(
      `📅 Upcoming: ${next.nextPeriod.name} in ${next.weeksUntil} weeks`,
