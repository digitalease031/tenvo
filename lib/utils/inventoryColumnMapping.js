...
export const DOMAIN_COLUMN_SYNONYMS = {
  'textile-wholesale': {
    ...
    'domain_data.colorshade': ['color', 'colour', 'shade', 'color/shade', 'colour/shade', 'rang', 'color shade'],
    ...
    'domain_data.thaanlength': ['thaan length', 'thaan', 'thaanlength', 'meters per thaan', 'thaan length (m)', 'thaan length meters'],
    'domain_data.thaan_breakdown': ['thaan meter', 'thaan meters', 'thaan breakdown', 'roll breakdown', 'roll lengths', 'thaan lengths', 'thaan breakdown (m)', 'thaan_breakdown', 'thaan breakdown meters'],
