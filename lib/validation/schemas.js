...
export const addStockSchema = z.object({
    ...
    manufacturing_date: z.union([z.string(), z.date()]).optional().nullable().transform(val => (val === '' || val === undefined) ? null : val),
    expiry_date: z.union([z.string(), z.date()]).optional().nullable().transform(val => (val === '' || val === undefined) ? null : val),
